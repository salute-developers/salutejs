...
- feat: Добавлены виджеты в SystemMessage ([@ivan-ushatsky](https://github.com/ivan-ushatsky))
...
- feat: Заголовок для активной карточки оператора ([@sasha-tlt](https://github.com/sasha-tlt))
...
- feat: Обновлены стили PlasmaButtonView ([@ivan-ushatsky](https://github.com/ivan-ushatsky))
...
- fix: Не срабатывает RUN_APP ([@soulko](https://github.com/soulko))
...
- feat: Добавлен ExtendedListCard в SystemMessage ([@ivan-ushatsky](https://github.com/ivan-ushatsky))
...
- feat: опциональное поле intent в ответе ([@sasha-tlt](https://github.com/sasha-tlt))
